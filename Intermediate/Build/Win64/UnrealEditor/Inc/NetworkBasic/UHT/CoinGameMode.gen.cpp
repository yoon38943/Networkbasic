...
struct Z_Construct_UClass_ACoinGameMode_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_PickupPoint_MetaData[] = {
		{ "ModuleRelativePath", "CoinFramework/CoinGameMode.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_FellOutPoint_MetaData[] = {
		{ "ModuleRelativePath", "CoinFramework/CoinGameMode.h" },
	};
#endif // WITH_METADATA
	static const UECodeGen_Private::FObjectPropertyParams NewProp_MyGameState;
	static const UECodeGen_Private::FIntPropertyParams NewProp_PickupPoint;
	static const UECodeGen_Private::FIntPropertyParams NewProp_FellOutPoint;
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_ACoinGameMode_Statics::NewProp_PickupPoint = { "PickupPoint", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ACoinGameMode, PickupPoint), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_PickupPoint_MetaData), NewProp_PickupPoint_MetaData) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_ACoinGameMode_Statics::NewProp_FellOutPoint = { "FellOutPoint", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ACoinGameMode, FellOutPoint), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_FellOutPoint_MetaData), NewProp_FellOutPoint_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ACoinGameMode_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ACoinGameMode_Statics::NewProp_PickupPoint,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ACoinGameMode_Statics::NewProp_FellOutPoint,
};
...
struct Z_CompiledInDeferFile_FID_NetworkBasic_1__Source_NetworkBasic_CoinFramework_CoinGameMode_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ACoinGameMode, ACoinGameMode::StaticClass, TEXT("ACoinGameMode"), &Z_Registration_Info_UClass_ACoinGameMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACoinGameMode), 3586513860U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_NetworkBasic_1__Source_NetworkBasic_CoinFramework_CoinGameMode_h_2163124400(TEXT("/Script/NetworkBasic"),
