...
// Begin Class ACoinGameState Function GetPlayerStatesOrdered
struct Z_Construct_UFunction_ACoinGameState_GetPlayerStatesOrdered_Statics
{
	struct CoinGameState_eventGetPlayerStatesOrdered_Parms
	{
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ACoinGameState_GetPlayerStatesOrdered_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_APlayerState_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_ACoinGameState_GetPlayerStatesOrdered_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CoinGameState_eventGetPlayerStatesOrdered_Parms, ReturnValue), EArrayPropertyFlags::None, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ACoinGameState_GetPlayerStatesOrdered_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ACoinGameState_GetPlayerStatesOrdered_Statics::NewProp_ReturnValue_Inner,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ACoinGameState_GetPlayerStatesOrdered_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ACoinGameState_GetPlayerStatesOrdered_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ACoinGameState_GetPlayerStatesOrdered_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ACoinGameState, nullptr, "GetPlayerStatesOrdered", nullptr, nullptr, Z_Construct_UFunction_ACoinGameState_GetPlayerStatesOrdered_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ACoinGameState_GetPlayerStatesOrdered_Statics::PropPointers), sizeof(Z_Construct_UFunction_ACoinGameState_GetPlayerStatesOrdered_Statics::CoinGameState_eventGetPlayerStatesOrdered_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54080401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ACoinGameState_GetPlayerStatesOrdered_Statics::Function_MetaDataParams), Z_Construct_UFunction_ACoinGameState_GetPlayerStatesOrdered_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_ACoinGameState_GetPlayerStatesOrdered_Statics::CoinGameState_eventGetPlayerStatesOrdered_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_ACoinGameState_GetPlayerStatesOrdered()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ACoinGameState_GetPlayerStatesOrdered_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(ACoinGameState::execGetPlayerStatesOrdered)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	*(TArray<APlayerState*>*)Z_Param__Result=P_THIS->GetPlayerStatesOrdered();
	P_NATIVE_END;
}
// End Class ACoinGameState Function GetPlayerStatesOrdered
...
void ACoinGameState::StaticRegisterNativesACoinGameState()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		{ "GetPlayerStatesOrdered", &ACoinGameState::execGetPlayerStatesOrdered },
	};
...
struct Z_Construct_UClass_ACoinGameState_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_ACoinGameState_GetPlayerStatesOrdered, "GetPlayerStatesOrdered" }, // 3879106558
	};
...
struct Z_CompiledInDeferFile_FID_NetworkBasic_1__Source_NetworkBasic_CoinFramework_CoinGameState_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ACoinGameState, ACoinGameState::StaticClass, TEXT("ACoinGameState"), &Z_Registration_Info_UClass_ACoinGameState, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACoinGameState), 42635104U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_NetworkBasic_1__Source_NetworkBasic_CoinFramework_CoinGameState_h_627755790(TEXT("/Script/NetworkBasic"),
